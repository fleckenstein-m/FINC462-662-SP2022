...
#Set-up packages
begin
	using DataFrames, Dates, Plots, PlutoUI, Printf, LaTeXStrings, HypertextLiteral, CSV, Chain, Statistics, PrettyTables
	# gr();
	# Plots.GRBackend()
	plotly()
...
# ╔═╡ 61f07a45-3a6b-4b8c-aeca-fa4e0242e14e
#helper functions
begin
...
# ╔═╡ 673c296a-f910-407c-8653-f939aae3aac6
# begin 
# 	html"""
# 	<hr>
# 	<p style="padding-bottom:3cm"> </p>
# 	<div align=center style="font-size:35px; font-weight:bold; font-family:family:Georgia"> The U.S. Treasury Market</div>
...
md"""
#### Example: Hedging Interest Rate Risk using Duration
"""
...
md"""
#### Example: Hedging Interest Rate Risk using Duration and Convexity
"""
