...
``\$f(\\textrm{June 2023}, \\textrm{Dec 2023}) = 2\\times \\left( \\frac{\\left(1+\\frac{r_{1.5}}{2}\\right)^{2\\times 1.5}}{\\left(1+\\frac{r_{1.0}}{2} \\right)^{2\\times 1.0}} -1 \\right) = $(roundmult(fVec_62[2],1e-6))= $(roundmult(fVec_62[2]*100,1e-4))\\%\$``
")
