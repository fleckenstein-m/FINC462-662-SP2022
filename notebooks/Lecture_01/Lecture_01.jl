...
# ╔═╡ b3bbfe88-b60f-4696-b325-d4a329aec601
#Set-up packages
begin
...
begin 
	...
	<p style="padding-bottom:1cm"> </p>
	<p align=center style="font-size:25px; font-family:family:Georgia"> <b> Introduction to Fixed Income Markets </b> <p>
	<p style="padding-bottom:1cm"> </p>
...
begin
	...
	<fieldset>      
		...
		<br>
        <input type="checkbox" value="">Get a sense of what "Fixed Income" means.<br>      
		<br>
        <input type="checkbox" value="">Learn about different segments of the Fixed Income markets.<br>
		<br>
	    <input type="checkbox" value="">Get to know different types of Fixed Income securities<br>      
		<br>
    </fieldset>      
	"""
end
...
- On August 5, 2020, the US Government announced the auction of a 30-year coupon bond.
  - The face value issued was $26bn.
  - Every six months, starting on February 15, 2021, the US Government would pay interest. (coupons)
  - The US Government agreed to pay the face value back on August 15, 2050. (maturity)
$vspace
- [Auction announcement](https://treasurydirect.gov/instit/annceresult/press/preanre/2020/A_20200805_2.pdf)
- [Auction results](https://www.treasurydirect.gov/instit/annceresult/press/preanre/2020/R_20200813_3.pdf)
"""
...
- The US Government bond discussed on the last slide gives us a framework for how to think about fixed income securities, but this example is just the tip of the iceberg.
$vspace
- **Issuers**: Federal government, municipalities, corporations, foreign governments,   government agencies
- **Coupons**: Fixed, Zero, Variable
- **Option-like features**: option to call, conversion, option to put
- **Collateral**
"""
...
md"""
We can classify the Fixed Income Market into _sectors_ based on the **issuer** of fixed income securities.
...
- **Corporate Bonds**
  - Securities issued in the U.S. by U.S. corporations and foreign corporations
...
@bind cat_Out MultiSelect(["Treasury","Corporate Debt","Municipal","Mortgage-Related","Federal Agency Securities","Asset-Backed","Money Markets"])
...
md"""
## Fixed Income Amounts Issued
Annual data at year-end in trillions of dollars.\
_Source: SIFMA_
"""

# ╔═╡ 17bd885d-7958-4d28-a6c4-9b83706b4423
@bind cat_Iss MultiSelect(["Treasury","Corporate Debt","Municipal","Mortgage-Related","Federal Agency Securities","Asset-Backed"]; default=["Treasury"])
...
LocalResource("./US_FI_Outstanding.png",:width => 400)

# ╔═╡ 0da38ef4-6c0f-4ebc-81eb-ef8314919843
md"""
## Market Size of Fixed Income and Equity Markets
_Source_: SIFMA and Bloomberg
"""

# ╔═╡ 370971d0-6181-47f9-a9e5-b903891ebd21
#Fixed Income Market Total Amount Outstanding vs Equity
begin
	...
	let
		...
		MktCaps = leftjoin(EquMktCap,FI_Out[:,[:Year,:Total]], on=:Year)
		select!(MktCaps,:Year,:Total=>"Fixed Income",:Equity)
		...
		minY = 0.0
		maxY = 60.0
		plot!(plot_MktCap, MktCaps.Year,MktCaps."Fixed Income", 
			  xlim=(minX,maxX), ylim=(minY, maxY),
			  ylabel="Trillions of Dollars", label="Fixed Income",
			  legend = :topleft, title="Fixed Income vs. Equity Markets")	
...
md"""
# Treasury Securities
- Obligations of the US Government, used to finance government spending.
- US Treasury is the largest single issuer of debt in the world.
...
md"""
## Are U.S. Treasury Securities Riskfree?
- In this course, we will treat US Government debt as default-free. 
- This, however, does not mean that Treasury securities are “risk-free."
- We will study these risks in this course in detail and learn strategies to hedge such risk.
"""

# ╔═╡ 2430deed-808b-4ef2-bffc-568a034f2a3a
md"""
## Types of Treasury securities
- Treasury Bills: maturity 1 year or less
- Treasury Notes: maturity from 1 to 10 years
- Treasury Bonds: maturity greater than 10 years, up to 30 years.
...
md"""
# Agency Securities
- Debt issues by US Agencies
  - Example: [Tennessee Valley Authority](http://www.tva.com/abouttva/history.htm)
- Debt issues by Government-sponsored entities (GSEs)
  - Examples: [Fannie Mae](http://www.fanniemae.com), [Freddie Mac](http://www.freddiemac.com/), [FHLB](http://www.fhlbanks.com/)
- Mortgage-backed securities issued by Fannie Mae, Freddie Mac, and [Ginnie Mae](http://www.ginniemae.gov/)
- GSEs have the dual purpose of earning profits for shareholders and also serving a public purpose (i.e. promoting home ownership).
...
- **General obligation**: backed by full faith and credit of the issuing municipality
- **Revenue bonds**: backed by cash flows from a particular project 
- Default risk may be significant depending on the municipality
- Tax exemption from federal taxes (and many state and local taxes
- Examples: [Build America Bonds](https://www.treasury.gov/press-center/press-releases/Pages/tg81.aspx), [Delaware Municipal Bonds](http://delaware.municipalbonds.com/bonds/recent/), __University of Delaware Bonds__
"""

# ╔═╡ 99a81e2a-ec51-4dec-af68-96de180f3d55
md"""
## University of Delaware Bonds
"""
...
LocalResource("./UDel_Munis_3.png",:width => 900)
...
LocalResource("./UDel_Munis_2.png",:width => 900)
...
- Major issuers include:
  - Financial firms: Goldman Sachs, Bank of America
  - Large manufacturers: Ford, GM, Caterpillar, GE 
...
LocalResource("./CreditCardABS.png",:width => 900)
...
- "Short-term" fixed income securities with maturities from overnight, to a few months.
- Commercial Paper
- Certificates of Deposit
- Money Market Funds
- Repurchase Agreements
- Monitored by the Federal Reserve Board in Washington, DC.
  - [Short-Term Funding Markets](https://www.federalreserve.gov/econres/rsstfm-staff.htm)
  - [Money Market Analysis](https://www.federalreserve.gov/econres/mamma-staff.htm)
"""
...
begin
	...
	<fieldset>      
        <legend>Our goals for today</legend>      
		<br>
        <input type="checkbox" value="" checked>Get a sense of what "Fixed Income" means.<br>      
		<br>
        <input type="checkbox" value="" checked>Learn about different segments of the Fixed Income markets.
		<br><br>
		<input type="checkbox" value="" checked>Get to know different types of Fixed Income securities<br>      	<br><br>
    </fieldset>      
	"""
end
